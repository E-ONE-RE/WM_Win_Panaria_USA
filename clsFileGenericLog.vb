...
Public Class clsFileGenericLog
    ...
    Public AbsoluteFileName As String
    Public FileName As String
    Public DateOnFileName As String
    Public StadardApplicationLogFileName As Boolean
    Public GenericLogFileName As Boolean

    Public Sub SetLogFileName(Optional ByVal inLogFileName As String = "", Optional ByVal inLogLevelDtl As FileLogLevelDtlEnum = FileLogLevelDtlEnum.LogLevelDtlOnlyError)
        '**************************************
        ...
        End Try
    End Sub
    Private Function WriteLog(ByVal inString As String) As Long
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
        Dim RetCode As Long
        ...
        End Try
    End Function
    Public Function WriteLog(ByVal inErrorInfoType As clsProgramError.ErrorInfoTypeEnum, ByVal inClassObjectName As String, ByVal inMethodName As String, ByVal inExceptionCode As Long, ByVal inExcepionDescription As String, ByVal inString As String) As Long
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
        Dim RetCode As Long
