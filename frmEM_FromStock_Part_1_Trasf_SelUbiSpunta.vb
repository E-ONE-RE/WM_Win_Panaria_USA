...
Public Class frmEM_FromStock_Part_1_Trasf_SelUbiSpunta

    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmEM_FromStock_Part_1_Trasf_SelUbiSpunta"
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Call clsNavigation.Show_Ope_EntrataMerci_FromStock(Me, clsEMFromStock.EM_Stock_SourceType.EM_Stock_SourceTypeUM_MovTransfUnLoad, clsDataType.WizardDirectionStepType.WizardDirectionStepTypeNext, True)
...
#If Not APPLICAZIONE_WIN32 = "SI" Then
			...
			cmdNextScreen.Text = clsAppTranslation.GetSingleParameterValue(1470, cmdNextScreen.Text, "<")
#Else
