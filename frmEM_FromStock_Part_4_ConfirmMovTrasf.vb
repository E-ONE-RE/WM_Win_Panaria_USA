...
Public Class frmEM_FromStock_Part_4_ConfirmMovTrasf
    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmEM_FromStock_Part_4_ConfirmMovTrasf"
...
#End If
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Dim Out_WmsJobs As String
        Dim Out_JobsGroup As String
        Dim Out_TruckDayNr As String
        Dim Out_TrasfNumPallet As String
        '**************************************
        Try 'HERE PUT NORMAL EXECUTION CODE
            '**************************************
            ...
            RetCode = clsSapWS.Call_ZWMS_EXEC_ENT_MERCE_PRODUZIONE(clsEMFromStock.UdMTrasfList, clsUser.SapWmsUser.LGNUM, clsUser.SapWmsUser.USERID, clsUser.SapWmsUser.USERID, clsUser.SapWmsUser.LANGUAGE, OT_Executed_Ok, SapFunctionError, OT_Executed_Number, Doc_Mat_INFO, clsEMFromStock.UdMTrasfList, Out_WmsJobs, Out_JobsGroup, Out_TruckDayNr, Out_TrasfNumPallet, False)
            ...
            Else
                ...
                ErrDescription += clsAppTranslation.GetSingleParameterValue(1244, "", " TRUCK No.:") & Out_TruckDayNr & vbCrLf
                ErrDescription += clsAppTranslation.GetSingleParameterValue(1250, "", " JOBS:") & Out_WmsJobs & vbCrLf
                ErrDescription += clsAppTranslation.GetSingleParameterValue(1243, "", " JOBS GROUP:") & Out_JobsGroup & vbCrLf
                ErrDescription += clsAppTranslation.GetSingleParameterValue(1245, "", " PALLET No.:") & Out_TrasfNumPallet & vbCrLf
            ...
            If (RetCodeFinal <> 0) Then
                ...
                If (UserAnswer <> Windows.Forms.DialogResult.Yes) Then
                    ...
                    If Not (clsEMFromStock.EM_StockSourceType = clsEMFromStock.EM_Stock_SourceType.EM_Stock_SourceTypeUM_MovTransfLoad) Then
                    ...
                    Else
                        ...
                        frmEM_FromStock_Part_4_ConfirmMovTrasfForm.cmdNextScreen.Focus()
                    End If
    ...
    Private Function RefreshDatiMaterialeAttivo() As Long
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            If (Not clsEMFromStock.UdMTrasfList Is Nothing) Then
                'AGGIORNO IL NUMERO DI UDC LETTE
                Me.lblInfoUDC.Text = clsAppTranslation.GetSingleParameterValue(1241, "", "N° UDC/S: ") & Trim(Str(clsEMFromStock.UdMTrasfList.GetLength(0)))
            End If
