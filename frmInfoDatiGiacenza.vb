...
Imports clsDataType
Imports clsUtility
Imports HookEventArgs
Imports KbdHookCS


Public Class frmInfoDatiGiacenza
    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmInfoDatiGiacenza"
    ...
    Private Sub frmInfoDatiGiacenza_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        '**************************************
    ...
    Private Sub frmInfoDatiGiacenza_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
...
#End If
            ...
            Me.Text = clsAppTranslation.GetSingleParameterValue(1174, Me.Text, "Giacenze")

            btnClose.Text = clsAppTranslation.GetSingleParameterValue(252, btnClose.Text, "Chiudi")

            '**************************************  

            If Not (clsInfoGiacenze.objDataTableDetailsGiacenza Is Nothing) Then
                clsInfoGiacenze.objDataTableDetailsGiacenza.DefaultView.AllowNew = False '>>> NON PERMETTO CREAZIONE NUOVE RIGHE NELLA DATAGRID
                Me.DtGridInfo.DataSource = clsInfoGiacenze.objDataTableDetailsGiacenza
            End If
            ...
            'refresh dei dati
            RetCode += clsInfoGiacenze.RefreshDateTableDetailsInfo()
...
#End If
    ...
    Private Sub cmdNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNext.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            clsInfoGiacenze.objDetailsDataRow = clsUtility.ExecDataTableMove(clsInfoGiacenze.objDataTableGiacenzeInfo, clsInfoGiacenze.RowIndex, clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypeNext)
    ...
    Private Sub cmdPrevious_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrevious.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            'IMPOSTO IL DATA ROW DELL'ELEMENTO DI CUI VISUALIZZARE I DATI
            clsInfoGiacenze.objDetailsDataRow = clsUtility.ExecDataTableMove(clsInfoGiacenze.objDataTableGiacenzeInfo, clsInfoGiacenze.RowIndex, clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypePrev)
            clsInfoGiacenze.RefreshDateTableDetailsInfo()
    ...
    Private Sub cmdLast_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLast.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            'IMPOSTO IL DATA ROW DELL'ELEMENTO DI CUI VISUALIZZARE I DATI
            clsInfoGiacenze.objDetailsDataRow = clsUtility.ExecDataTableMove(clsInfoGiacenze.objDataTableGiacenzeInfo, clsInfoGiacenze.RowIndex, clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypeLast)
            clsInfoGiacenze.RefreshDateTableDetailsInfo()
    ...
    Private Sub cmdFirst_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFirst.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            'IMPOSTO IL DATA ROW DELL'ELEMENTO DI CUI VISUALIZZARE I DATI
            clsInfoGiacenze.objDetailsDataRow = clsUtility.ExecDataTableMove(clsInfoGiacenze.objDataTableGiacenzeInfo, clsInfoGiacenze.RowIndex, clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypeFirst)
            clsInfoGiacenze.RefreshDateTableDetailsInfo()
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Select Case inDateTableMoveOpType
                ...
                Case clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypeNext
                    If clsInfoGiacenze.RowIndex < clsInfoGiacenze.objDataTableGiacenzeInfo.Rows.Count - 1 Then
                        cmdLast.Enabled = True
                        cmdNext.Enabled = True
                        cmdPrevious.Enabled = True
                        cmdFirst.Enabled = True
                ...
                Case clsUtility.DateTableMoveOpTypeEnum.DateTableMoveOpTypeNone
                    Select Case clsInfoGiacenze.RowIndex
                        Case 0
                            ...
                            cmdPrevious.Enabled = False
                            cmdFirst.Enabled = False
                        Case clsInfoGiacenze.objDataTableGiacenzeInfo.Rows.Count - 1
                            cmdLast.Enabled = False
                            cmdNext.Enabled = False
                            cmdPrevious.Enabled = True
                            cmdFirst.Enabled = True
