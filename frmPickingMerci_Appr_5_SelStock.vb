...
Public Class frmPickingMerci_Appr_5_SelStock

    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmPickingMerci_Appr_5_SelStock"
    ...
    Public Sub KeyPressed(ByVal inKey As Integer)
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Call frmPickingMerci_Appr_5_SelStock_KeyPress(Me, e)
    ...
    Private Sub frmPickingMerci_Appr_5_SelStock_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        '**************************************
    ...
    Private Sub frmPickingMerci_Appr_5_SelStock_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
...
#End If
            ...
            Me.Text = clsAppTranslation.GetSingleParameterValue(167, Me.Text, "Picking Appr. (5)")
...
#End If
            ...
            Me.Text = clsAppTranslation.GetSingleParameterValue(673, Me.Text, "Picking x Pronto (5)") & "-" & clsWmsJob.GetRowCountGiacenzeOriInfo(False)
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            If (clsWmsJob.MaterialeSelStockGiacenzaOri.TipoStock = "S") Then
                ...
                Exit Sub
            End If
            If (clsWmsJob.MaterialeSelStockGiacenzaOri.TipoStock = "Q") Then
                ErrDescription = clsAppTranslation.GetSingleParameterValue(674, "", "Attenzione, stock selezionato con TIPO STOCK 'Q' non prelevabile.") & vbCrLf & clsAppTranslation.GetSingleParameterValue(348, "", "Verificare e riprovare")
                MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Exit Sub
            End If
            ...
            If (DefaultPickingMerci_Ori_Exclude_LgtypPronto = True) Then
                If (clsWmsJob.MaterialeSelStockGiacenzaOri.UbicazioneInfo.TipoMagazzino = clsSapUtility.cstSapTipoMagPronto) Then
