...
Public Class frmPickingMerci_Appr_SelStockOrigine

    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmPickingMerci_Appr_SelStockOrigine"
    ...
    Public Sub KeyPressed(ByVal inKey As Integer)
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Call frmPickingMerci_Appr_SelStockOrigine_KeyPress(Me, e)
    ...
    Private Sub frmPickingMerci_Appr_SelStockOrigine_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        '**************************************
    ...
    Private Sub frmPickingMerci_Appr_SelStockOrigine_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
...
#End If
            ...
            If Not (clsWmsJob.objDataTableGiacenzeOriInfo Is Nothing) Then
                clsWmsJob.objDataTableGiacenzeOriInfo.DefaultView.AllowNew = False '>>> NON PERMETTO CREAZIONE NUOVE RIGHE NELLA DATAGRID
            ...
            Me.Text = "Picking x Sel.Stock" & "-" & clsWmsJob.GetRowCountGiacenzeOriInfo(False)
    ...
    Public Function RefreshMaterialeInfo() As Long
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Me.txtInfoRowSelected.Text = clsWmsJob.FromMatSelStockGiacenzaOriToString(0)
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Select Case SourceForm.GetType.Name
                Case frmPickingMerci_Appr_4_Sel_UbiOrigine.Name
                    frmPickingMerci_Appr_4_Sel_UbiOrigineForm.ConfermaSelezioneLocazione(clsWmsJob.MaterialeSelStockGiacenzaOri.UbicazioneInfo.Ubicazione)
                    frmPickingMerci_Appr_4_Sel_UbiOrigineForm.Show()
                Case frmPickingMerci_Appr_4_Ubi_e_UM_Origine.Name
                    frmPickingMerci_Appr_4_Ubi_e_UM_OrigineForm.ConfermaSelezioneLocazione(clsWmsJob.MaterialeSelStockGiacenzaOri.UbicazioneInfo.Ubicazione)
                    frmPickingMerci_Appr_4_Ubi_e_UM_OrigineForm.Show()
                Case Else
                    ErrDescription = clsAppTranslation.GetSingleParameterValue(751, "", "Caso SouceForm Non prevista (Disaccantona. Scelta Origine).")
                    MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
