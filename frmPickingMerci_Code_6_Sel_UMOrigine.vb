...
Public Class frmPickingMerci_Code_6_Sel_UMOrigine

    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmPickingMerci_Code_6_Sel_UMOrigine"
    ...
    Public Sub KeyPressed(ByVal inKey As Integer)
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Call frmPickingMerci_Code_6_Sel_CodMatOrigine_KeyPress(Me, e)
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            If (clsWmsJob.SkuOrUnitaMagEntered = clsDataType.SkuOrUnitaMagEnteredEnum.SkuOrUnitaMagEnteredSku) Then
                ...
                'ATTENZIONE! La struttura [UbicazioneInfo] ha a volte la PALLET ID impostata e non devo considerarla in questo filtro
                DatiRicercaSKUUbicazione.Divisione = clsWmsJob.WmsJob.MaterialeGiacenzaOrigine.UbicazioneInfo.Divisione
                DatiRicercaSKUUbicazione.NumeroMagazzino = clsWmsJob.WmsJob.MaterialeGiacenzaOrigine.UbicazioneInfo.NumeroMagazzino
                DatiRicercaSKUUbicazione.TipoMagazzino = clsWmsJob.WmsJob.MaterialeGiacenzaOrigine.UbicazioneInfo.TipoMagazzino
                DatiRicercaSKUUbicazione.Ubicazione = clsWmsJob.WmsJob.MaterialeGiacenzaOrigine.UbicazioneInfo.Ubicazione
    ...
    Private Sub frmPickingMerci_Code_6_Sel_CodMatOrigine_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
        Dim RetCode As Long = 0
        '**************************************
    ...
    Private Sub frmPickingMerci_Code_6_Sel_CodMatOrigine_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '**************************************
        'HERE PUT DECLARATION OF LOCAL VARIABLE
        Dim RetCode As Long = 0
...
#End If
            ...
            Me.lblCodiceUM.Text = clsAppTranslation.GetSingleParameterValue(1736, lblCodiceUM.Text, "Codice UM/SKU")
...
#End If
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PBoxInsPalletId.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            clsSelezioneUnitaMagazzino.SourceForm = frmPickingMerci_Code_6_Sel_UMOrigineForm
    ...
    Private Sub txtCodiceUM_TextChanged(sender As Object, e As EventArgs) Handles txtCodiceUM.TextChanged
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            If Len(txtCodiceUM.Text) = 1 Then
                ...
                clsProgramError.ManageLogErrorCondition(CodeClassObjectName, "", clsProgramError.ErrorInfoTypeEnum.ErrorInfoTypeLog, "Inizio - Barcode Scan: " + wkStart_time_read)
                Exit Sub
            End If
