...
Public Class frmPrintLabelKTag

    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmPrintLabelKTag"
    ...
    Private Sub cmdAbortScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAbortScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            Call clsNavigation.Show_Ope_PrintLabelKTag(Me, clsDataType.WizardDirectionStepType.WizardDirectionStepTypePrevious, True)
    ...
    Private Sub cmdNextScreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNextScreen.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            If (Me.txtNr.Text = "") Then
                ErrDescription = clsAppTranslation.GetSingleParameterValue(1752, "", "Il numero minimo di copie è 0.")
                MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Exit Sub
            End If

            If (IsNumeric(Me.txtNr.Text) <> True) Then
                ErrDescription = clsAppTranslation.GetSingleParameterValue(555, "", "Nessun dato trovato.Verificare i dati immessi e riprovare.")
                MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Exit Sub
            End If

            If (Val(Me.txtNr.Text) <= 0) Then
                ErrDescription = clsAppTranslation.GetSingleParameterValue(1752, "", "Il numero minimo di copie è 0.")
                MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Exit Sub
            End If

            If (Val(Me.txtNr.Text) > 99) Then
                ErrDescription = clsAppTranslation.GetSingleParameterValue(1753, "", "Il numero massimo di copie è 99.")
                MessageBox.Show(ErrDescription, AppMsgBoxTitle, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
                Exit Sub
            End If
            ...
            RetCode = clsSapWS.Call_ZWMS_EXEC_PRINT_PALLET_KTAG(WorkGiacenza, txtNr.Text, GetDataOk, SapFunctionError, False)
...
#End If
            ...
            lblNr.Text = clsAppTranslation.GetSingleParameterValue(1748, lblNr.Text, "Nr.Copie")

            Me.Text = clsAppTranslation.GetSingleParameterValue(1667, Me.Text, "Stampa Label KTAG")
