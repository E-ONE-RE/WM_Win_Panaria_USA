...
Public Class frmSelectUbicazioneDropUDS
    '*****************************************
    'MANAGE OF CODE VERSION
    Private Const CodeClassObjectName As String = "frmSelectUbicazioneDropUDS"
...
#End If
            ...
            Me.Text = clsAppTranslation.GetSingleParameterValue(1425, Me.Text, "Selezione Ubicazione di Deposito")
            ...
            If Not (clsSelezioneUbicazione.objDataTableSelectUbicazioneDropUDS Is Nothing) Then
                clsSelezioneUbicazione.objDataTableSelectUbicazioneDropUDS.DefaultView.AllowNew = False '>>> NON PERMETTO CREAZIONE NUOVE RIGHE NELLA DATAGRID
                Me.DtGridInfo.DataSource = clsSelezioneUbicazione.objDataTableSelectUbicazioneDropUDS
            End If
            ...
            If (Not (clsSelezioneUbicazione.objDataTableSelectUbicazione Is Nothing)) Then
                Me.Text = clsAppTranslation.GetSingleParameterValue(1425, "", "Selezione Ubicazione di Deposito") & " - " & clsSelezioneUbicazione.objDataTableSelectUbicazioneDropUDS.Rows.Count
            End If
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Try 'HERE PUT NORMAL EXECUTION CODE
            ...
            WorkDataRow = clsSelezioneUbicazione.objDataTableSelectUbicazioneDropUDS.Rows(Me.DtGridInfo.CurrentRowIndex)
